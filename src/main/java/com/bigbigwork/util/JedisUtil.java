...
public class JedisUtil {
    ...
    private static final String REDIS_IP = "47.98.97.241";
    private static final String REDIS_PASSWORD = "test0171201redis";
    private static final int REDIS_PORT = 6333;
    ...
    static {
        ...
        //redis如果设置了密码：
        jedisPool = new JedisPool(config, REDIS_IP, REDIS_PORT, 10000, REDIS_PASSWORD);
